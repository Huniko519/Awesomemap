                ...
                <form method="POST" action="" class="install">
                    <fieldset>
                        ...
                        <div class="alert alert-info">
                            In this part, we will set up the database. Just copy and paste your DB infos in
                            the form below.
                        </div>
                        <div class="form-group">
                            <label for="host_db">Hostname</label>
                            <input
                                value="<?php echo $database_host ?>"
                                type="text"
                                class="form-control"
                                name="host_db"
                                id="host_db"
                                placeholder="Your DB hostname (localhost or something else)">
                        </div>
                        <div class="form-group">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input
                                value="<?php echo $admin_password_2 ?>"
                                type="password"
                                class="form-control"
                        ...
                        <div class="alert alert-warning">
                            ...
                            <strong>"incudes/db.php"</strong>
                            has the writing access (chmod 666).
                        </div>
                        <hr/>
                        <div style="text-align:center;">
                            <input
                                name="submit"
                                type="submit"
                                value="Launch the Install Process &rarr;"
