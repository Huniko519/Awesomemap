	...
	<body>
		<div class="container">
			...
			<form>
				<div class="checkbox">
				    <label>
				    	<input name="check_search_bar" class="check_search_bar" type="checkbox"> Show the autocomplete search bar on the map
				    </label>
				</div>
				<div class="checkbox">
				    <label>
				    	<input name="check_cluster" class="check_cluster" style='margin-top:11px;' type="checkbox"> Use "Marker Clusterer" (it will show a clickable icon (<img style='height:37px' src='img/markerclusterer/m1.png' alt='' />) when there are a lot of markers in one location)
				    </label>
				</div>
			...
			<div class="save_map_block clearfix well" style="padding-left:0;">
				...
				<a href="" class="btn btn-success save_this_map"><i class="fa fa-check"></i> Save the Map</a>
				<hr style="border-color: #D9D9D9;" />
				<a class="btn btn-info" onClick="_gaq.push(['_trackEvent', 'External Link', 'CodeCanyon Purchase']);" href="http://codecanyon.net/item/awesome-map-fully-customizable-markers-map/6695203?ref=axool"><i class="fa fa-tag"></i> <b>Purchase Awesome Map</b> (Only $11)</a>
			</div>
		</div>
			...
			<div class="modal-dialog modal-dialog-center">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form role="form" id="up_form" method="POST" enctype="multipart/form-data" action='upload.php'>
								<input type="hidden" class="mapaw_lat" value="" />
								<input type="hidden" class="mapaw_lng" value="" />
								<div class="mapaw_part1">
								<div class="alert alert-info">
									New Pin for the address : <div class="modal_address"></div>
								</div>
								<fieldset>
									<legend>General Informations</legend>
									<div class="form-group">
										<label for="Name">Name</label>
										<input type="text" class="form-control mapaw_name" id="Name" placeholder="The name of your pin which will appear in bold.">
									</div>
									<div class="form-group">
										<label for="Description">Description</label>
										<textarea class="form-control mapaw_desc" id="Description" placeholder="The description of your pin. It can be the slogan of a shop or whatever you want."></textarea>
									</div>
									<div class="form-group streetview_preview_form">
										<hr />
										<label>
									    	<input type="checkbox" class="sv_preview"> Add a StreetView Preview
									    </label>
									    <div class="or_preview">
									    OR
									    </div>
									    <label>
									    	<input type="checkbox" class="oi_preview"> Add your Own Image
									    </label>
									    <div class="well oi_well">
									    	<input type="file" class="oi_image" name="oi_image" style="display:inline;" />
									    	<div class="alert alert-info oi_preview_up">
