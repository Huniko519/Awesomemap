    ...
    <body>
        <div class="container demo">
            ...
            <div class="alert alert-info">
                Here is just a simple example of what you can make with
                <strong>Awesome Map</strong>...<br/>But don't just stay on this page : all the
                    awesomeness happens on the admin page, where you can customize the map, the
                    markers, the search bar...
            ...
            <div class="features">
                <h3 class="feature_title">
                    ...
                    Pin Creator</h3>
                <p>
                    With our great Pin Creator, you can entirely customize your markers / pins.
                    Choose the icon, the marker style, the color... And it's dramatically easy to
                    use!
                    <br/><br/>
                    <div style="text-align:center">
                ...
                <h3 class="feature_title">
                    ...
                    369 icons for your markers</h3>
                <p>
                    Choose between 369 cutomizable icons for your markers thanks to the great
                    <a
                        target="_blank"
                        style="color:white;"
                        href="http://fortawesome.github.io/Font-Awesome/icons/">Font-Awesome</a>
                    library.
                </p>
                <br/>
                <p>
                ...
                <h4>
                    ...
                    Streetview integration</h4>
                <p>
                    Check the streetview integration option in the Pin Creator and a streetview
                    preview image will appear in the marker's infobox.
                </p>
                ...
                <h4>
                    <i class="fa fa-check-circle-o"></i>
                    TinyMCE integration</h4>
                <p>
                    The TinyMCE editor is integrated in this item. You can write and style your
                    infobox thanks to this great jQuery plugin.
                </p>
                <p style="text-align:center;">
                ...
                <h4>
                    <i class="fa fa-check-circle-o"></i>
                    Drag & Drop automation</h4>
                <p>
                    Once you have created your markers with the awesome "Pin Creator", you can just
                    drag & drop them to the place you want : the informations (address, streetview
                    preview) will be automatically updated.
                </p>
